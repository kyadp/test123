...
local konstantdecompiler = loadstring(game:HttpGet('https://raw.githubusercontent.com/kyadp/test123/refs/heads/main/konstantdecompiler.lua'))()
	...
	do
		...
		pcall(function()
			local b64_enc_buf = loadstring(
				game:HttpGet("https://raw.githubusercontent.com/kyadp/test123/refs/heads/main/re64.lua", true),
				"Base64"
			)().encode
...
local function synsaveinstance(CustomOptions, CustomOptions2)
	...
	do
		...
		pcall(function()
			PlaceName ..= " " .. service.MarketplaceService:GetProductInfo(PlaceName).Name .. "_" .. os.date("%m_%d_%Y_%I_%M%p"):lower()
		end)
